...
def execute_SVL_query(cluster_object, end_time, file_config, redshift_user, start_time):
    with open("tools/external-object-replicator/sql/external_table_query.sql", "r") as svv_external_table:
    ...
    with open("tools/external-object-replicator/sql/svl_s3_list.sql", "r") as svl_s3_list:
...
def execute_stl_load_query(cluster_object, end_time, file_config, redshift_user, start_time):
    ...
    with open("tools/external-object-replicator/sql/stl_load_query.sql", "r") as stl_load:
