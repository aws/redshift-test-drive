...
export default class TutorialPanelWrapper extends ComponentWrapper {
    ...
    findTutorials(): import("@awsui/test-utils-core/selectors").MultiElementWrapper<TutorialItemWrapper>;
    findDownloadLink(): LinkWrapper;
    findTaskList(): import("@awsui/test-utils-core/selectors").MultiElementWrapper<TutorialTaskWrapper>;
...
declare class TutorialTaskWrapper extends ComponentWrapper {
    ...
    findSteps(): import("@awsui/test-utils-core/selectors").MultiElementWrapper<ElementWrapper>;
}
export {};
